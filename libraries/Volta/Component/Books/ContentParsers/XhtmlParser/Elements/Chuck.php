 ...
 */
class Chuck extends BaseElement
{
    private array $_jokes = [
    ...
    /**
     * @see BaseElement->onTranslateData();
     */
    ...
    {
        return '<div class="chuck">' .str_replace('Chuck Norris', '<strong>Chuck Norris</strong>', $this->_jokes[rand(0, count($this->_jokes)-1)]). '</div>';
    }
}